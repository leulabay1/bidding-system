...
<%
    ...
    clientInfo = (HashMap<String, Integer>) request.getAttribute("clientInfo");
%>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="left-component">
        ...
        <div class="history">
            ...
            <div class="history-row">
                <p>Money made</p> <p><%=clientInfo.get("totalMoneyMade")%>$</p>
            </div>
            <div class="history-row">
                <p>Posted items</p><p> <%=clientInfo.get("totalItems")%></p>
            </div>
            <div class="history-row">
                <p>Pending items</p> <p> <%=clientInfo.get("totalPendingItems")%></p>
            </div>
            <div class="history-row">
                <p>Sold items </p> <p><%=clientInfo.get("totalPaidItems")%></p>
            </div>
        </div>
    </div>
    <div class="right-component" style="position: relative;">
        <div class="tab-container">
            <div class="tab active" data-target="tab1">All Items</div>
            <div class="tab" data-target="tab2">Sold Items</div>
            <div class="tab" data-target="tab3">Pending Items</div>
        </div>

        <div class="accept-button" style="position: absolute; right: 10px; top: 10px;">
            <a
            href="create-item.jsp"
            >Add +</a>
        </div>

        <div id="tab1" class="tab-content active" style="display: flex; flex-direction: column; align-items: center;">
            ...
            <% for (Item item : items) { %>
                ...
                <div class="card">
                    ...
                    <div class="card-details">
                        ...
                        <p class="card-desc"><%=item.getDescription()%></p>
                        <div class="bottom-desc">
                            <p>Max Bid: $<%=item.getMaxAmount()%></p>
                            <form action="client-item-detail" method="GET">
