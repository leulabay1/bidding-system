...
<div class="main-container">
  ...
  <div class="right-component">
    <h2 class="detail-sub-heading">People Who Bid On This Item</h2>
    <% for (Bid bid : bids) { %>
      <div class="bidder-card">
        <img src="https://via.placeholder.com/50" alt="Bidder Image">
        <div>
          <p>Name: <%= bid.getBidderName()%></p>
          <p>Bid Date: <%= bid.getDate()%></p>
          <p>Bid Amount: <%= bid.getAmount()%></p>
        </div>

        <% if (!item.isClosed()) { %>
          <form class="detail-form" action="select-bid" method="post">
