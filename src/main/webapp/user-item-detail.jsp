...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="style/itemDetail.css">
...
<div class="main-container">
    <div class="left-component" style="display: flex; flex-direction: column; align-items: center;">
        <div class="profile-section"  style="width: 100%;">
            <div class="button-pic">
                <img class="avatar" src="image/Client.jpg" alt="Profile Image">
            </div>
            <h2 class="profile-name"><%= client.getName()%></h2>
        </div>
    ...
    <div class="right-component">
        <div class="item-details">
            ...
            <div class="accept-button">
                <button>Item is closed</button>
            </div>
            <% } %>
            <p>End of Bid Date: <%=item.getEndDate()%></p>
            <p>Maximum Bid: $<%=item.getMaxAmount()%></p>
        </div>
    </div>
</div>
